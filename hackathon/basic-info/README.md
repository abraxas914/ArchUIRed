...
team_name: Arch Park
project_name: ArchUI
project_definition_en: Agent-Native Modular Knowledge Orchestration Engine
project_definition_zh: Agent-native 的模块化知识编排引擎
project_value: 让 AI 可靠导航、高效理解、安全协作——让工作知识可维护、可复用、可生成。
project_tagline: "Orchestrate once, generate everywhere."
```
